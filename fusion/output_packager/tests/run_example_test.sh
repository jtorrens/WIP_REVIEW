...
grep -F 'ClientReviewPackager = GroupOperator {' "$EXAMPLE" >/dev/null
grep -F 'CleanReviewPackager = GroupOperator {' "$EXAMPLE" >/dev/null
grep -F 'ClientReviewSaver = Saver {' "$EXAMPLE" >/dev/null
grep -F 'CleanReviewSaver = Saver {' "$EXAMPLE" >/dev/null
