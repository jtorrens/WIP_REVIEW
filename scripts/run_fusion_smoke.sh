...
require_record 'MANAGED_COLOR .*mode=1 .*display_encoding="Rec\.709 Gamma 2\.4" graphics_white_mode=0 graphics_white_nits=100\.000000 .*working_space=display-light-linear working_premult=true encode_count=1' 'P4 Rec.709 display-linear render'
require_record 'MANAGED_COLOR .*mode=1 .*display_encoding="Rec\.2100 PQ" graphics_white_mode=0 graphics_white_nits=203\.000000 .*working_space=display-light-linear working_premult=true encode_count=1' 'P4 PQ Graphics White'
require_record 'MANAGED_COLOR .*mode=1 .*display_encoding="Rec\.2100 HLG" graphics_white_mode=0 graphics_white_nits=203\.000000 hlg_peak_nits=1000\.000000 .*encode_count=1' 'P4 HLG Graphics White'
