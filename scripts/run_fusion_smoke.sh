...
require_record 'TEXT_ZONE .*zone="TL" enabled=true prefix="CLIP KEEPS THIS COMPLETE UTF-8 STRING ÁRTICO OUTSIDE CELL" .*rendered_text="CLIP KEEPS THIS COMPLETE UTF-8 STRING ÁRTICO OUTSIDE CELL" .*effective_scale=1\.000000 overflowed=true clipped=true ellipsized=false cell=\[29,630\]' 'P2d Clip result'
...
require_record 'TEXT_ZONE .*zone="TC" enabled=true prefix="ELLIPSIS PRESERVES UTF-8 ÁRTICO AND REPLACES THE TAIL" .*rendered_text="[^"]*…" .*effective_scale=1\.000000 overflowed=true clipped=false ellipsized=true cell=\[650,1270\]' 'P2d UTF-8 Ellipsis result'
...
require_record 'TEXT_ZONE .*zone="TR" enabled=true prefix="SHRINK TO FIT THIS CELL" .*effective_scale=0\.[6-9][0-9]* overflowed=true clipped=false ellipsized=false cell=\[1290,1891\]' 'P2d ShrinkToFit result'
require_record 'TEXT_ZONE .*zone="BL" enabled=true prefix="MINIMUM SCALE STILL CANNOT FIT THIS DELIBERATELY VERY LONG STRING AND MUST CLIP" .*effective_scale=0\.600000 overflowed=true clipped=true ellipsized=false cell=\[29,630\]' 'P2d minimum-scale Clip result'
...
require_record 'CALCULATED_FIELD_ZONE .*zone="TC" prefix="DF " resolved="DF 00:00:59;29" effect_frame=1799 .*drop_compatible=true drop_applied=true .*used_timecode_fallback=false' 'P3 29.97 DF before minute boundary'
require_record 'CALCULATED_FIELD_ZONE .*zone="TC" prefix="DF " resolved="DF 00:01:00;02" effect_frame=1800 .*drop_compatible=true drop_applied=true .*used_timecode_fallback=false' 'P3 29.97 DF minute boundary'
require_record 'CALCULATED_FIELD_ZONE .*zone="BR" prefix="INVALID TC " resolved="INVALID TC 00:00:00:01" effect_frame=0 frame_rel=1 .*fps_valid=true drop_compatible=false drop_applied=false timecode_start_valid=false used_timecode_fallback=true' 'P3 invalid timecode controlled fallback'
